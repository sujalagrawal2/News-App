...
import com.example.newsapp.databinding.FragmentEntermentNewsBinding
...
class EntermentNewsFragment : Fragment() {
    private var newsAdapter = NewsAdapter()
    private lateinit var binding: FragmentEntermentNewsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEntermentNewsBinding.inflate(layoutInflater)
        ...
        lifecycleScope.launch {
            try {
                val response = withContext(Dispatchers.IO) {
                    RetrofitInstance.api.getNewsItems("entertainment", country!!,
                        language!!,
                        maxLine,
                        search!!)
                }
